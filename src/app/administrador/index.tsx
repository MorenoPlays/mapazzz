  ...
  return (
    <NavigationContainer>
      ...
      <Drawer.Navigator
        ...
        drawerContent={(props) => (
          <CustomDrawerContent {...props} setStatePage={setStatePage} />
        )}
        screenOptions={{
      ...
      >
        <Drawer.Screen
          ...
          options={{ title: 'Admin - MapZzzz' }}
        />
        <Drawer.Screen
          name="ClinicUpdate"
          component={ClinicUpdateScreen}
          options={{ title: 'Portal de Unidades' }}
        />
        <Drawer.Screen
          name="Authorities"
          component={AuthoritiesScreen}
          options={{ title: 'Portal de Autoridade Sanitária' }}
        />
      </Drawer.Navigator>
    </NavigationContainer>
  );
